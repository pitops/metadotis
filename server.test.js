...
test('post new magnet', async () => {
  ...
  let response = await axios.post('http://localhost:3000/magnet', {magnet})
...
test('get files', async () => {
  ...
  let response = await axios.get('http://localhost:3000/files?hash=' + hash)
...
test('get file', async () => {
  ...
  response = await axios.get(`http://localhost:3000/file?hash=${hash}&name=${file}`)
